...
## Nucleo Board (F401RE)
We have used F401RE board if not you can work with cheaper boards such as Blackpill as well just go through ST documentation (datasheets and reference manual) ![Image](F401_diagram.png)
